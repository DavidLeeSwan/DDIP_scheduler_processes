...
def daily_process():
    ...
    # ddip.table_scrub.company_scrub(filepath=f'{output_str}new_companies.csv', errored_file=False, output_dir=output_str)
    ...
    #     ddip.table_scrub.company_scrub(filepath=f'{output_str}Errored_Companies_{datetime.today().strftime("%Y-%m-%d")}.csv', output_dir=output_str)
    ...
    # # ---------------- Branches ------------------
    # #loads to the data table
    # ddip.table_scrub.branch_scrub(filepath=f'{output_str}new_branches.csv', errored_file=False, output_dir=output_str)
    ...
    #     ddip.table_scrub.branch_scrub(filepath=f'{output_str}Errored_Branches_{datetime.today().strftime("%Y-%m-%d")}.csv', output_dir=output_str)
    ...
    #     ddip.table_scrub.contact_scrub(filepath=f'{output_str}Errored_Contacts_{datetime.today().strftime("%Y-%m-%d")}.csv', output_dir=output_str)
